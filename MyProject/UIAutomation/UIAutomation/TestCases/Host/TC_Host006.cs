...
{
    /// <summary>
    /// Summary description for TC_Host006
    /// </summary>
    [CodedUITest]
    public class TC_Host006
    {
        public TC_Host006()
        {
        }
        ...
        public void CodedUITestMethod1()
        {
            ...
            infor[1] = this.AddHostWizard.InputHostInfoAndTest(infor, false, true);
            this.AddHostWizard.ClickAddButton();
            this.AddHostWizard.AsserInputHostIPAddress();
